...
NOTE: These datasets have been uploaded to zenodo due to github size limitation. Download from the link: https://doi.org/10.5281/zenodo.10686166
...
cancer_gr2 %>% 
  ...
  as_tibble() %>% 
  select(name, degree_centrality=centrality)
```
